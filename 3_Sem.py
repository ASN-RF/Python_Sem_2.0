...
# Output: 6
Vibor = int(input('Вы хотите ввести список чсиле сами или использовать список из примера: \n1 - вввести самому\n2 - использовать список из примера '))
if Vibor == 1:
    spisok = list(input('Введиите Ваши любимы числа через проблел: ').split())
elif Vibor == 2:
    spisok = [1, 1, 2, 0, -1, 3, 4, 4]
else:
    print ('К сожалению такие варианты не предусмотрены GAME OVER!!!')
