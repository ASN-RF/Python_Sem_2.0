...
# #  3 вариант (Семинар)
# print (f'Input: {class_1} {class_2} {class_3}\nOutput: {class_1//2 + class_1 % 2 + class_2 //2 + class_2 % 2 + class_3 //2 + class_3 % 2}')
# print (class_1 % 2)
# print (class_2 % 2)
# print (class_3 % 2)
# -------КОНЕЦ ЗАДАЧИ-------

# Задача 9. Вагоны в электричке пронумерованы натуральными числами, начиная с 1 (при этом иногда вагоны  
...
# Output: 6
# Number_Golova = int(input('Введите номер вагона от головы: '))
# Number_Vagon = int(input('Введите номер вагона: '))
# if Number_Golova == Number_Vagon:
#     print ('К сожалению без дополнительной информации это сделать невозможно!')
# else:
#     print (f'Input: {Number_Golova} {Number_Vagon}\nOutput: {Number_Golova+Number_Vagon-1}')

# -------КОНЕЦ ЗАДАЧИ-------

# Задача 10. Дано натуральное число. Требуется определить, является ли год с данным номером високосным. Если 
